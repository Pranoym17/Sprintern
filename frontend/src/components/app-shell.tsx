...
import { BellRing, BriefcaseBusiness, CircleUserRound, Filter, LayoutDashboard, LogOut, Rows3, Settings } from "lucide-react";
import { Brand } from "@/components/brand";
import { useApp } from "@/components/app-provider";
import { SiteFooter } from "@/components/site-footer";

const nav=[{href:"/dashboard",label:"Overview",icon:LayoutDashboard},{href:"/jobs",label:"Job board",icon:Rows3},{href:"/matches",label:"Matches",icon:BellRing},{href:"/applications",label:"Tracker",icon:BriefcaseBusiness},{href:"/filters",label:"Filters",icon:Filter},{href:"/settings",label:"Settings",icon:Settings}];
