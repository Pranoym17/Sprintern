...
export default function TermsPage() { return <TrustPage eyebrow="Plain-language terms" title="Terms of use" intro="Use Sprintern as a discovery and tracking aid, then verify every opportunity with the employer before applying.">
  <TrustSection title="The service"><p>Sprintern aggregates public internship postings, applies your filters, and sends optional alerts. Coverage may change as public job information changes.</p></TrustSection>
  ...
  <TrustSection title="No affiliation"><p>Sprintern is an independent service. It is not affiliated with, endorsed by, or acting for listed employers or its service providers.</p></TrustSection>
