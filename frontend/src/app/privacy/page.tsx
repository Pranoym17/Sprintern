...
export default function PrivacyPage() { return <TrustPage eyebrow="Your data" title="Privacy at Sprintern" intro="Sprintern keeps only the information needed to match internships, deliver alerts, and help you track applications.">
  ...
  <TrustSection title="Services involved"><p>Supabase provides authentication and database services. Telegram and Resend receive the minimum delivery information required when you enable those channels. Public job-data providers supply posting information.</p></TrustSection>
