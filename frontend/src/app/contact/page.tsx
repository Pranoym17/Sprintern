...
const configuredSupportEmail = process.env.NEXT_PUBLIC_SUPPORT_EMAIL;
const supportEmail = configuredSupportEmail && !configuredSupportEmail.endsWith("@example.com")
  ? configuredSupportEmail
  : "support@sprintern.ca";
export default function ContactPage() { return <TrustPage eyebrow="Support" title="Contact Sprintern" intro="Questions, data requests, broken application links, and responsible security reports are welcome.">
  ...
  <TrustSection title="Job corrections"><p>Report broken or misleading listings and confirm the current status on the employer’s official website.</p></TrustSection>
</TrustPage>; }
