...
MIXED_TERM_README = "\n".join(
    [
        ...
        "| JanMay Co | QA Intern | Jan - May 2028 | [Apply](https://example.com/janmay) |",
...
async def test_github_infers_mixed_terms_with_explicit_priority() -> None:
    ...
    assert by_company["Fallback Co"].term == "Winter 2027"
    assert by_company["Range Co"].term == "Fall 2027"
    assert by_company["JanMay Co"].term == "Winter 2028"
    assert by_company["Offcycle Co"].term is None
